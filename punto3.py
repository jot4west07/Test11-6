from lista import by_hegiht, by_house, by_name, by_temp, show_list, show_list_list, search, remove, by_species
...
for i in range(len(jedis)):
    dato1 = jedis[i]
    if dato1['species'] is None: # Si la especie es None no se puede ciclar con for, por eso se cambia a "Sin datos"
        dato1['species'] = "Sin datos"
jedis.sort(key=by_species)
species=[]
for i in range(len(jedis)):
    dato2 = jedis[i]
    species.append(dato2['species'])
print("Especies ordenadas alfabeticamente:")
...
print("Ashoka Tano esta en la posicion: ",search(jedis,'name','Ahsoka Tano'))
print(jedis[42])
print("Kit Fisto esta en la posicion: ",search(jedis,'name','Kit Fisto'))
print(jedis[30])
...
for i in range(len(jedis)):
    dato1 = jedis[i]
    if dato1['master'] == 'Yoda': 
        padawans_yoda.append(dato1['name'])
    if dato1['master'] == 'Luke':
        padawans_luke.append(dato1['name'])

for i in range (len(padawans_yoda)):
    
    print(padawans_yoda[i],end=" ")
print("")
for i in range (len(padawans_luke)):
    print(padawans_luke[i],end=" ")
print("")